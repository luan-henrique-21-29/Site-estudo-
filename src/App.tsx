...
export default function App(){
 return <HashRouter><RouteTracker/><Onboarding/><Suspense fallback={<Loading/>}><Routes><Route element={<Layout/>}>
  ...
  <Route path="countries" element={<CountriesPage/>}/><Route path="countries/:id" element={<CountryPage/>}/><Route path="country-guide/:id" element={<CountryGuidePage/>}/><Route path="compare-countries" element={<CountryComparePage/>}/>
