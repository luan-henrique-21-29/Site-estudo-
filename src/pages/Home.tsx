import { ArrowRight, BookOpenCheck, Brain, Flame, ListChecks, Sparkles, Target, Wrench } from 'lucide-react'
...
export function Home() {
  ...
  return <div className="page page-home">
    ...
    <section className="glass-panel feature-card"><Wrench/><span className="eyebrow">Ferramentas</span><h2>Simule antes de decorar.</h2><p>Juros compostos e simples, inflação, rentabilidade real, metas, orçamento, porcentagem e câmbio manual.</p><Link className="text-link" to="/tools">Abrir ferramentas →</Link></section>
  </div>
}
