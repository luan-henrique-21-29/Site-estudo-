import { ArrowRight, BookOpenCheck, Brain, Code2, Flame, ListChecks, Sparkles, Target, WalletCards, Wrench } from 'lucide-react'
...
export function Home() {
  ...
  return <div className="page page-home">
    ...
    <section className="split-grid"><article className="glass-panel feature-card"><WalletCards/><span className="eyebrow">Salários e câmbio</span><h2>Quanto dá por hora e por mês?</h2><p>Compare pisos salariais dos países, veja equivalentes mensais e conversão aproximada para reais com câmbio atualizado.</p><Link className="text-link" to="/salaries">Comparar salários →</Link></article><article className="glass-panel feature-card"><Code2/><span className="eyebrow">Programação prática</span><h2>Escreva código e veja funcionando.</h2><p>Use o playground de HTML, CSS e JavaScript com preview isolado e rascunho salvo no navegador.</p><Link className="text-link" to="/playground">Abrir playground →</Link></article></section>
    <section className="glass-panel feature-card"><Wrench/><span className="eyebrow">Ferramentas</span><h2>Simule antes de decorar.</h2><p>Juros compostos e simples, inflação, rentabilidade real, metas, orçamento, porcentagem e outras ferramentas educativas.</p><Link className="text-link" to="/tools">Abrir ferramentas →</Link></section>
  </div>
}
